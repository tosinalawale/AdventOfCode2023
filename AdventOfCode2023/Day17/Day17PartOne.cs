    ...
    public class Day17PartOne
    {
        ...
        private static List<Node> GetAdjacentPositions(int[,] valueGrid, Node currentNode)
        {
            ...
            if (currentCol < gridWidth - 1
                && CanMoveToNextPosition(valueGrid, currentNode, (row: currentRow, col: currentCol + 1)))
            ...
            if (currentRow < gridHeight - 1
                && CanMoveToNextPosition(valueGrid, currentNode, (row: currentRow + 1, col: currentCol)))
                adjacentPositions.Add(new Node
                {
        ...
        private static bool CanMoveToNextPosition(int[,] valueGrid, Node currentNode,
            (int row, int col) nextPosition)
        {
            ...
            return ((currentNode.Direction != newDirection)
                   || currentNode.StraightStepsSoFar < 3)
